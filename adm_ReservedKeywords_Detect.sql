-- Desc: See if any objects are using reserved keywords
...
-- Auth: Brian Dill 2020-11-30
-- Script home: https://github.com/wbdill/SQLServer-sandbox01/adm_ReservedKeywords_Detect
-- Other useful files: https://github.com/wbdill/SQLServer-sandbox01


DROP TABLE #tmpReservedWords
CREATE TABLE #tmpReservedWords ( val VARCHAR(100) )

INSERT INTO #tmpReservedWords VALUES ('ADD'), ('EXTERNAL'), ('PROCEDURE'), ('ALL'), ('FETCH'), ('PUBLIC'), ('ALTER')
, ('FILE'), ('RAISERROR'), ('AND'), ('FILLFACTOR'), ('READ'), ('ANY'), ('FOR'), ('READTEXT'), ('AS'), ('FOREIGN')
, ('RECONFIGURE'), ('ASC'), ('FREETEXT'), ('REFERENCES'), ('AUTHORIZATION'), ('FREETEXTTABLE'), ('REPLICATION')
...
, ('INNER'), ('SEMANTICKEYPHRASETABLE'), ('COLUMN'), ('INSERT'), ('SEMANTICSIMILARITYDETAILSTABLE'), ('COMMIT')
, ('INTERSECT'), ('SEMANTICSIMILARITYTABLE'), ('COMPUTE'), ('INTO'), ('SESSION_USER'), ('CONSTRAINT'), ('IS')
, ('SET'), ('CONTAINS'), ('JOIN'), ('SETUSER'), ('CONTAINSTABLE'), ('KEY'), ('SHUTDOWN'), ('CONTINUE'), ('KILL')
, ('SOME'), ('CONVERT'), ('LEFT'), ('STATISTICS'), ('CREATE'), ('LIKE'), ('SYSTEM_USER'), ('CROSS'), ('LINENO')
, ('TABLE'), ('CURRENT'), ('LOAD'), ('TABLESAMPLE'), ('CURRENT_DATE'), ('MERGE'), ('TEXTSIZE'), ('CURRENT_TIME')
...
SELECT * FROM sys.tables WHERE [name] IN ( SELECT val FROM #tmpReservedWords )

SELECT * FROM sys.views WHERE [name] IN ( SELECT val FROM #tmpReservedWords )

SELECT * FROM sys.procedures WHERE [name] IN ( SELECT val FROM #tmpReservedWords )

SELECT * FROM sys.objects WHERE type IN ('FN', 'IF', 'TF') AND [name] IN ( SELECT val FROM #tmpReservedWords )
